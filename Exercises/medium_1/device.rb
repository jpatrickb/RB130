# Below we have a listening device. It lets us record something that is said and store it for later 
# use. In general, this is how the device should be used:
...
# then no block will be passed in. The listening device can also output the most recent recording 
# using a Device#play method.
