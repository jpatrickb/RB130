...
# The Enumerable#drop_while method begins by iterating over the members of a collection, passing 
# each element to the associated block until it finds an element for which the block returns 
# false or nil. It then converts the remaining elements of the collection (including the element
...
def drop_while(array)
  index = 0
  array.each do |item|
    return array[index..-1] if !yield(array[index])
